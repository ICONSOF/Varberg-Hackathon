# TODO — Hackathon Varberg 260428

## Kvar att göra

- [ ] **Starter kit** — Skapa ett enkelt HTML/JS-skelett med Leaflet + exempeldata som grupperna kan utgå från
- [ ] **Gå igenom och justera app-idéerna** — Kontrollera att idéerna i hackathon-app-ideas.md matchar aktuella filer, storlekar och datakällor
